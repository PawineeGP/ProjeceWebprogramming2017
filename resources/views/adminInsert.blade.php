              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  ...
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-xs-4">
                        <form action="insertBreak" method="post" class="pure-form pure-form-stacked">
                          <fieldset>
                            <legend>อาหารเช้า</legend>
                            <label for="name">ชื่ออาหารเช้า</label>
  		                        <input type="text" name="Bname" placeholder="ชื่ออาหาร">
                            <label for="callories">จำนวนแคลอรี่</label>
                              <input type="text" name="Bcalories" placeholder="จำนวณแคลอรี่">
  	                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                              <input type="submit" name="submit" value="เพิ่ม" class="pure-button pure-button-primary"></input>
                          </fieldset>
                        </form>
                      </div>
                      <!-- lunch -->
                      <div class="col-xs-4">
                        <form action="insertLunch" method="post" class="pure-form pure-form-stacked">
                          <fieldset>
                            <legend>อาหารเที่ยง</legend>
                            <label for="name">ชื่ออาหารเที่ยง</label>
                              <input type="text" name="Lname" placeholder="ชื่ออาหาร">
                            <label for="callories">จำนวนแคลอรี่</label>
                              <input type="text" name="Lcalories" placeholder="จำนวณแคลอรี่">
                              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                              <input type="submit" name="submit" value="เพิ่ม" class="pure-button pure-button-primary"></input>
                          </fieldset>
                        </form>
                      ...
                      <!-- อาหารเย็น -->
                      <div class="col-xs-4">
                        <form action="insertDinner" method="post" class="pure-form pure-form-stacked">
                          <fieldset>
                            <legend>อาหารเย็น</legend>
                            <label for="name">ชื่ออาหารเย็น</label>
                              <input type="text" name="Dname" placeholder="ชื่ออาหาร">
                            <label for="callories">จำนวนแคลอรี่</label>
                              <input type="text" name="Dcalories" placeholder="จำนวณแคลอรี่">
                              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                              <input type="submit" name="submit" value="เพิ่ม" class="pure-button pure-button-primary"></input>
                          </fieldset>
                        </form>
